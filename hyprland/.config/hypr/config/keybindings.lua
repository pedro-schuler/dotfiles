...
local FullscreenWindowBind =
	hl.bind(mainMod .. " + F", hl.dsp.window.fullscreen_state({ internal = 3, client = 3, action = "toggle" }))
hl.bind(
	mainMod .. " + SHIFT + W",
...
hl.bind(mainMod .. " + ALT + P", hl.dsp.exec_cmd(programs.printAndAnnotate))
hl.bind(mainMod .. " + X", hl.dsp.exec_cmd(programs.lock))
hl.bind(mainMod .. " + Z", hl.dsp.exec_cmd(programs.clipboard))
hl.bind(mainMod .. " + SPACE", hl.dsp.exec_cmd(programs.menu))
hl.bind(mainMod .. " + T", hl.dsp.window.float({ action = "toggle" }))
hl.bind(mainMod .. " + P", hl.dsp.window.pseudo())
hl.bind(mainMod .. " + SHIFT + A", hl.dsp.layout("togglesplit")) -- dwindle only
